...
/*ICI MODIF Fleche*/
		    //On efface la fleche au demarrage du site
		    $(".coda-nav-right").fadeOut(1);
		  
		  	//detection du 1er clic
		    $("#disto,#delay,#noise,#compressor, .tab2,.tab3,.tab4,.tab5").click(function() {
		    	//affiche fleche
		       $(".coda-nav-right").delay(1500).fadeIn(400);
		       
		    });

		    //Detection clic sur fleche
            $(".coda-nav-right").click(function() {
            	
            	//On recherche dans quel slide nous nous trouvons pour faire apparaitre le bon popup
		       	var whatSlide = $(".panel-container").css("margin-left");
		       	if(whatSlide == '-1900px') whatSlide = 'slide1';
		       	if(whatSlide == '-3800px') whatSlide = 'slide2';
		       	if(whatSlide == '-5700px') whatSlide = 'slide3';
		       	if(whatSlide == '-7600px') whatSlide = 'slide4';
		       	if(whatSlide == '-9500px') whatSlide = 'slide5';

		       	if(whatSlide == 'slide2'){
		       		jQuery.facybox('<span class="titre_qcm">TEST TES CONNAISSANCES</span><span class="content_qcm_disto">Comment une distorsion produit elle le son “distordu” ?<br/><form id="myForm" method="POST" action="#"><label for="q1"><input id="q1" type="radio" name="q1" checked="checked" value="1">grâce à un tube à vide</input></label><img class="croix_q1" src="img/croix2.png" alt="croix2" /><br/><label for="q2"><input id="q2" type="radio" name="q1" value="2">par l’augmentation du sustain</input></label><img class="croix_q2" src="img/croix2.png" alt="croix2" /><br/><label for="q3"><input id="q3" type="radio" name="q1" value="3">par l’augmentation du niveau sonore</input></label><img class="croix_q3" src="img/croix2.png" alt="croix2" /><br/><br/>Quel est la différence entre un overdrive et une distorsion ?<br/><label for="q4"><input id="q4" type="radio" name="q2" checked="checked" value="1">la distorsion est uniquement réservé pour le blues</inpu></label><img class="croix_q4" src="img/croix2.png" alt="croix2" /><br/><label for="q5"><input id="q5" type="radio" name="q2" value="2">aucune</input></label><img class="croix_q5" src="img/croix2.png" alt="croix2" /><br/><label for="q6"><input id="q6" type="radio" name="q2" value="3">le niveau de saturation du son</input></label><img class="croix_q6" src="img/croix2.png" alt="croix2" /></form><br/><div id="valider_qcm_disto"></div></span>');
	       			$("#facybox .body").css("background","transparent url(img/content_disto/background_qcm_disto.png) no-repeat 3px 10px");
	       			$(".croix_q1, .croix_q2, .croix_q3, .croix_q4, .croix_q5, .croix_q6").fadeOut(1);
       				$("#hide_menu_delay").fadeOut('slow', function() {});
	       			$("#hide_delay").delay(800).fadeOut(400);
       			 	$('#myForm input[type=radio]').prettyCheckboxes({'display':'inline'});

       			 	
				
	       			//GESTION CORECTION 
	       			$("div#valider_qcm_disto").click(function() { 
	       				$(".croix_q1, .croix_q2, .croix_q3, .croix_q4, .croix_q5, .croix_q6").fadeOut(1);
						...
						if($('#q2').prop('checked')) {
		       				//affiche check2
		       				$(".croix_q2").attr("src","img/check2.png");
						    $(".croix_q2").fadeIn(400);
						}
						...
						if($('#q6').prop('checked')) {
		       				//affiche check2
		       				$(".croix_q6").attr("src","img/check2.png");
		       				$(".croix_q6").fadeIn(400);
						}

	       			});
	       		
	       		}else if(whatSlide == 'slide3'){
		       		jQuery.facybox('<span class="titre_qcm">TEST TES CONNAISSANCES</span><span class="content_qcm_delay">Sur quel principe de fonctionnement est basé le delay ?<br/><form id="myForm" method="POST" action="#"><label for="q1"><input id="q1" type="radio" name="q1" checked="checked" value="1">le sustain</input></label><img class="croix_q1" src="img/croix2.png" alt="croix2" /><br/><label for="q2"><input id="q2" type="radio" name="q1" value="2">le gain</input></label><img class="croix_q2" src="img/croix2.png" alt="croix2" /><br/><label for="q3"><input id="q3" type="radio" name="q1" value="3">l\'echo</input></label><img class="croix_q3" src="img/croix2.png" alt="croix2" /><br/><br/>Comment éviter les capharnaüms sonores en utilisant le delay ?<br/><label for="q4"><input id="q4" type="radio" name="q2" checked="checked" value="1">en utilisant une distorsion</input></label><img class="croix_q4" src="img/croix2.png" alt="croix2" /><br/><label for="q5"><input id="q5" type="radio" name="q2" value="2">en atténuant assez vite le son de sortie</input></label><img class="croix_q5" src="img/croix2.png" alt="croix2" /><br/><label for="q6"><input id="q6" type="radio" name="q2" value="3">en utilisant une distorsion</input></label><img class="croix_q6" src="img/croix2.png" alt="croix2" /></form><br/><div id="valider_qcm_delay"></div></span>');
	       			$("#facybox .body").css("background","transparent url(img/content_delay/background_qcm_delay.png) no-repeat 6px 10px");
	       			$(".croix_q1, .croix_q2, .croix_q3, .croix_q4, .croix_q5, .croix_q6").fadeOut(1);
	       			$("#hide_noise").delay(800).fadeOut(400);
		       		$("#hide_menu_noise").fadeOut('slow', function() {});
		       		$('#myForm input[type=radio]').prettyCheckboxes({'display':'inline'});
				
	       			$("div#valider_qcm_delay").click(function() { 
		       			$(".croix_q1, .croix_q2, .croix_q3, .croix_q4, .croix_q5, .croix_q6").fadeOut(1);
						...
						if($('#q3').prop('checked')) {
		       				//affiche check2
		       				$(".croix_q3").attr("src","img/check2.png");
		       				$(".croix_q3").fadeIn(400);
						}
						...
						if($('#q5').prop('checked')) {
		       				//affiche check2
		       				$(".croix_q5").attr("src","img/check2.png");
		       				$(".croix_q5").fadeIn(400);
						}
		       	...
		       	}else if(whatSlide == 'slide4'){
		       	   jQuery.facybox('<span class="titre_qcm">TEST TES CONNAISSANCES</span><span class="content_qcm_noise">A quoi sert un noise - gate ?<br/><form id="myForm" method="POST" action="#"><label for="q1"><input id="q1" type="radio" name="q1" checked="checked" value="1">éliminer les bruits parasitaires</input></label><img class="croix_q1" src="img/croix2.png" alt="croix2" /><br/><label for="q2"><input id="q2" type="radio" name="q1" value="2">bosster les aïgus</input></label><img class="croix_q2" src="img/croix2.png" alt="croix2" /><br/><label for="q3"><input id="q3" type="radio" name="q1" value="3">stargate ? c’est la porte des étoiles !</input></label><img class="croix_q3" src="img/croix2.png" alt="croix2" /><br/><br/>Comment émuler l’effet sur audacity ?<br/><label for="q4"><input id="q4" type="radio" name="q2" checked="checked" value="1">en passant d’une bande stéréo à une bande mono</input></label><img class="croix_q4" src="img/croix2.png" alt="croix2" /><br/><label for="q5"><input id="q5" type="radio" name="q2" value="2">dans le menu effets, noise gate</input></label><img class="croix_q5" src="img/croix2.png" alt="croix2" /><br/><label for="q6"><input id="q6" type="radio" name="q2" value="3">en générant du silence</input></label><img class="croix_q6" src="img/croix2.png" alt="croix2" /></form><br/><div id="valider_qcm_noise"></div></span>');
		       	   $("#facybox .body").css("background","transparent url(img/content_noise/background_qcm_noise.png) no-repeat 6px 10px");
		       	   $(".croix_q1, .croix_q2, .croix_q3, .croix_q4, .croix_q5, .croix_q6").fadeOut(1);
		       	   $("#hide_compressor").delay(800).fadeOut(400);
		       	   $("#hide_menu_compressor").fadeOut('slow', function() {});
		       	   $('#myForm input[type=radio]').prettyCheckboxes({'display':'inline'});

		       	   $("div#valider_qcm_noise").click(function() { 
		       			$(".croix_q1, .croix_q2, .croix_q3, .croix_q4, .croix_q5, .croix_q6").fadeOut(1);
	       						       			
		       			if($('#q1').prop('checked')) {
		       				//affiche croix2
		       				$(".croix_q1").attr("src","img/check2.png");
						    $(".croix_q1").fadeIn(400);
						} 
		       	...
		       	}else if(whatSlide == 'slide5'){
		       		jQuery.facybox('<span class="titre_qcm">TEST TES CONNAISSANCES</span><span class="content_qcm_compressor">Quel est le rôle premier d’un compresseur ?<br/><form id="myForm" method="POST" action="#"><label for="q1"><input id="q1" type="radio" name="q1" checked="checked" value="1">maintenir un volume de sortie homogène</input></label><img class="croix_q1" src="img/croix2.png" alt="croix2" /><br/><label for="q2"><input id="q2" type="radio" name="q1" value="2">maintenir un volume d’entrée élevé</input></label><img class="croix_q2" src="img/croix2.png" alt="croix2" /><br/><label for="q3"><input id="q3" type="radio" name="q1" value="3">maintenir toutes les notes jouées pendant 10 secondes</input></label><img class="croix_q3" src="img/croix2.png" alt="croix2" /><br/><br/>A quoi sert il d’autre ?<br/><label for="q4"><input id="q4" type="radio" name="q2" checked="checked" value="1">à rien, d’ailleiur cette pédale n’existe même pas</input></label><img class="croix_q4" src="img/croix2.png" alt="croix2" /><br/><label for="q5"><input id="q5" type="radio" name="q2" value="2">maintenir le son à son niveau sonore d’origine</input></label><img class="croix_q5" src="img/croix2.png" alt="croix2" /><br/><label for="q6"><input id="q6" type="radio" name="q2" value="3">éliminer le soufflement produit par une distorsion</input></label><img class="croix_q6" src="img/croix2.png" alt="croix2" /></form><br/><div id="valider_qcm_compressor"></div></span>');
		       		$("#facybox .body").css("background","transparent url(img/content_compressor/background_qcm_compressor.png) no-repeat 6px 10px");
		       		$(".croix_q1, .croix_q2, .croix_q3, .croix_q4, .croix_q5, .croix_q6").fadeOut(1);
		       		$(".coda-nav-right").fadeOut(400);
		       		$('#myForm input[type=radio]').prettyCheckboxes({'display':'inline'});

		       		 $("div#valider_qcm_compressor").click(function() { 
		       			$(".croix_q1, .croix_q2, .croix_q3, .croix_q4, .croix_q5, .croix_q6").fadeOut(1);
